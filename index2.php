...
if (empty($_SESSION['loggedin']) || $_SESSION['vaitro'] !== 'admin') {
    echo "<p>Bạn không có quyền truy cập vào trang này. Vui lòng đăng nhập với vai trò admin.</p>";
    exit;
}
?>
    ...
    <div class="container">
        <div class="sidebar">
            <ul>
                ...
                <br>
                <li><a href="logout.php" class="logout-btn">Đăng xuất</li>
            </ul>
